...
.type-nav .container .all {
  ...
  line-height: 45px;
  text-align: center;  /*調整讓文字水平對齊並置中*/
  color: #fff;
  font-size: 14px;
...
.type-nav .container .sort {
  left: 0; /*left需要搭配position屬性才會有作用*/
  top: 45px; /*top需要搭配position屬性才會有作用*/
  width: 210px;
  height: 465px;
  position: absolute;  /*圖層上浮*/
  background-color: #903838;
  z-index: 999; /*將元素圖層置於999樓*/
}
/*針對主要第一層大標題*/
...
/*第二層的標題形成方形框並移到畫面中間顯示*/
.type-nav .container .sort .all-sort-list2 .item .item-list {
  display: none;  /*讓中間顯示框初始顯示狀態為隱藏*/
  position: absolute;  
  width: 734px;
  min-height: 460px;
  background: #f7f7f7;
  left: 210px;  /*搭配position: absolute使用,並讓方框向右移*/
  border: 1px solid #ddd;
  top: 0;
  z-index: 9999 !important;  /*圖層上浮並將優先級別為最重要*/
}
/*藉由*/
