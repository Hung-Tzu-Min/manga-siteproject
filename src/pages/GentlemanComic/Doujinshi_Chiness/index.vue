<template>
  <div>
    <GCheader />
    <DoujinshiChinessBody
      :DCbodyData="DCbodyData"
    />
  </div>
</template>
...
import DoujinshiChinessBody from "./component/ChinessBody.vue";
...
export default {
      ...
      DCbodyData: [
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[セントラルフィールド (ぱいお)] 人妻恵理子の不貞記録｜人妻恵理子的不貞記録 [中国翻訳]",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
        ...
        },
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[山本善々] 隷属魔王 [DL版] [个人整合]",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
        ...
        },
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[メメ屋 (メメ50)] 性癖マッチングアプリ ズボプリ [幸德秋良与以北汉化 鬼畜王汉化组] [230517去码] [無修正]",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
        ...
        },
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[TGA] 巨根留学生のNTRホームステイ [中国翻訳]",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
        ...
        },
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[フリテン堂] モブ男子の俺が100人孕ませるまで出ることのできない子作り島に引っ越した結果 [中国翻訳] [DL版]",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
        ...
        },
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[もじゃりん] ちょっとMでドスケベで + メロンブックス限定小冊子 キャラクタープロット集 [篆儀通文書坊漢化]",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
        ...
        },
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[母印堂 (シベリアン母スキー)] 僕の母さんで、僕の好きな人。7 [中国翻訳]",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
        ...
        },
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[絵援隊 (酒呑童子)] 18号 系列",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
        ...
        },
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[しき] 巨乳巨尻ママを助けたければママの裸当ててみて [瓜皮汉化]",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
        ...
        },
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[OTOREKO (トイレ籠)] 無人島の吉村さん 1-7话+ 附加赠品",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
        ...
        },
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[伊達ろく] 妻と連れ子が同じ人（俺）を好きになるのは遺伝子的に当然！？1+2[甜族星人x我不看本子个人汉化]",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
        ...
        },
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[みとれいゆ] 代理出産をお願いされ、娘の夫を寝取ってしまった淫母+代理出産でセックスの虜になったお義母さんの話【无所吊谓】",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
        ...
        },
        {
          ...
          files: require.context(
            "@/assets/GCimages/Books/[うるうどき (おゆ)] 一途でいさせて [空気系☆漢化]",
            false,
            /\.(png|jpe?g|gif|svg)$/
          ),
  ...
  methods: {
    async fetchMockData() {
      try {
        const response = await axios.get("/api/data").then((res) => {
        
         return res.data
        });
        console.log(response.data)
      this.$store.dispatch('mock123',response.data)
      } catch (error) {
        throw error;
      }
    },
